    ...
    <>
      <section className="banner-waves relative bg-banner px-5 pb-7 pt-6 text-banner-foreground sm:px-8 sm:pb-9 sm:pt-7 lg:px-10">
        ...
        <div className="mt-1 flex items-center justify-between gap-3">
          ...
          >
            <span className="truncate text-[17px] font-bold leading-tight tracking-[-0.02em] sm:text-[20px] lg:text-[22px]">
              Select a batch
            </span>
            <ChevronDown
          ...
          <div className="relative shrink-0">
            <button
              ...
              className="grid size-8 place-items-center rounded-md text-banner-foreground/90 hover:bg-card/10"
            >
              <MoreVertical className="size-[18px]" strokeWidth={2.4} />
            </button>
            {menuOpen && (
              <div className="absolute right-0 top-10 z-10 w-[210px] overflow-hidden rounded-xl border border-border bg-popover text-popover-foreground shadow-pop">
                <button
                  type="button"
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-foreground/50 backdrop-blur-[2px]">
      <div className="flex h-full w-full max-w-[480px] flex-col bg-card">
        ...
        <div className="scrollbar-slim mt-6 flex-1 overflow-y-auto px-5 sm:px-8">
          <p className="text-[16px] font-bold text-foreground">Your Batches (0)</p>
